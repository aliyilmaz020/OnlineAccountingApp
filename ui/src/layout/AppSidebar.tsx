...
type MenuType = "main" | "others" | "accounting";
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (["main", "others", "accounting"] as MenuType[]).forEach((menuType) => {
      const items = menuType === "main" ? navItems : menuType === "others" ? othersItems : accountingItems;
